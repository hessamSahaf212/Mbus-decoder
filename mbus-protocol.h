...
#include <uchar.h>
 ...
 //   byte5: control = ...
 //   byte6: address = ...
 //   byte7: ctl.info= ...    72/76 for variable data struct.,  73/77 for fixed data s
 //   byte8: data    = ...
 //          ...     = ...
 //   byteN-1: chksum  = ...
 //   byteN: stop    = 0x16
...
char*mbus_data_variable_record_jSon(mbus_data_record* record, int record_cnt, int frame_cnt, mbus_data_variable_header* header);
